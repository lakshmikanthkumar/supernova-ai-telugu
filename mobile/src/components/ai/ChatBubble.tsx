...
const styles = StyleSheet.create({
  ...
  correctionRow: { flexDirection: 'row', alignItems: 'flex-start' },
  correctionOriginal: { fontSize: 13, color: '#EF4444', marginBottom: 2, flex: 1 },
  arrowRow: { marginVertical: 4, marginLeft: 20 },
  correctionFixed: { fontSize: 13, color: '#059669', fontWeight: '600', marginBottom: 2, flex: 1 },
  correctionExplanation: { fontSize: 12, color: '#374151', marginTop: 4, lineHeight: 18, marginLeft: 20 },
  correctionTelugu: { fontSize: 11, color: '#6B7280', marginTop: 2, marginLeft: 20 },
