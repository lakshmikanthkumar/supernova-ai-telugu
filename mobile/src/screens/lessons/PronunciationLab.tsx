...
const styles = StyleSheet.create({
  ...
  categoryScroll: { flexShrink: 0, marginTop: 10 },
  ...
  categoryTabActive: { backgroundColor: '#059669', borderColor: '#059669' },
  ...
  comeBackText: { fontSize: 15, fontWeight: '700', color: '#059669', textAlign: 'center', marginBottom: 4 },
  comeBackSub: { fontSize: 12, color: '#6B7280', textAlign: 'center' },
  restartBtn: { backgroundColor: '#059669', paddingHorizontal: 32, paddingVertical: 14, borderRadius: 14 },
