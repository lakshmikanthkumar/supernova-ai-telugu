...
export const MODELS: ModelConfig[] = [
  ...
  },
  {
    ...
    maxTokens: 512,
    strengths: ['chat', 'grammar_check', 'quiz_generation', 'simple_qa', 'word_explanation'],
    priority: 5,
    speed: 'fast',
  ...
  },
  {
    ...
    maxTokens: 512,
    strengths: ['chat', 'grammar_check', 'simple_qa'],
    priority: 6,
    speed: 'medium',
    contextWindow: 8192,
  },
...
const TASK_MODEL_PREFERENCE: Record<TaskType, ProviderId[]> = {
  ...
  chat:               ['groq-llama-70b', 'groq-mistral-saba', 'gemini-1.5-flash', 'groq-gemma2-9b', 'groq-llama-8b', 'openrouter-free'],
  interview_coaching: ['groq-llama-70b', 'groq-mistral-saba', 'gemini-1.5-flash', 'groq-gemma2-9b', 'groq-llama-8b', 'openrouter-free'],
  roleplay:           ['groq-llama-70b', 'groq-mistral-saba', 'gemini-1.5-flash', 'groq-gemma2-9b', 'groq-llama-8b', 'openrouter-free'],
  email_generation:   ['groq-llama-70b', 'groq-mistral-saba', 'gemini-1.5-flash', 'groq-gemma2-9b', 'groq-llama-8b', 'openrouter-free'],
  speech_analysis:    ['groq-llama-70b', 'groq-mistral-saba', 'gemini-1.5-flash', 'groq-gemma2-9b', 'groq-llama-8b', 'openrouter-free'],
  // Light tasks → prefer fast models
  grammar_check:      ['groq-llama-8b', 'groq-gemma2-9b', 'gemini-1.5-flash', 'openrouter-free', 'groq-llama-70b', 'groq-mistral-saba'],
  quiz_generation:    ['groq-llama-8b', 'groq-gemma2-9b', 'gemini-1.5-flash', 'openrouter-free', 'groq-llama-70b', 'groq-mistral-saba'],
  word_explanation:   ['groq-llama-8b', 'groq-gemma2-9b', 'gemini-1.5-flash', 'openrouter-free', 'groq-llama-70b', 'groq-mistral-saba'],
  translation:        ['groq-llama-8b', 'groq-gemma2-9b', 'gemini-1.5-flash', 'openrouter-free', 'groq-llama-70b', 'groq-mistral-saba'],
  simple_qa:          ['groq-llama-8b', 'groq-gemma2-9b', 'gemini-1.5-flash', 'openrouter-free', 'groq-llama-70b', 'groq-mistral-saba'],
}
